...
class ClipboardTwoFactorMonitor:
    ...
    def add_provider(self, provider: str):
        ...
        self.shared_state.pending_2fa_count = getattr(self.shared_state, 'pending_2fa_count', 0) + 1
    ...
    def remove_provider(self, provider: str):
        if provider in self.waiting_providers:
            ...
            self.shared_state.pending_2fa_count = max(0, getattr(self.shared_state, 'pending_2fa_count', 0) - 1)
